from keras.layers import Input, Conv2D, ReLU, MaxPool2D, GlobalAveragePooling2D


def vgg16_back(inpt, gap=False):
    ...
    # conv11: 1x1x128 conv + 3x3x256 s1 p0 conv  /  GAP
    if gap:
...
if __name__ == '__main__':
    ...
    features = vgg16_back(inpt, gap=True)
    print(features)
